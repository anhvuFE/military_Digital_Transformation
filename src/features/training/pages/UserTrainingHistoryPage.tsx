                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <div className="flex items-start gap-2 mb-1">
                      <h3 className="font-semibold text-forest leading-snug">
                  ...
                  {item.enrollment.status === "COMPLETED" && (
                    <div className="ml-2">
                      <div className={`min-w-[72px] rounded-lg px-3 py-2 text-center ${
                        item.enrollment.passed
                          ? "bg-green-50 text-green-700"
                          : "bg-red-50 text-red-700"
                      }`}>
                        <p className="text-lg font-bold">{item.enrollment.score || 0}</p>
