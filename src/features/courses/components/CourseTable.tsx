    ...
    <>
      ...
      <div className="sm:hidden space-y-4">
        {courses.map((course) => {
          ...
          return (
            <div key={course.id} className="card p-4 shadow-sm hover:shadow-md transition-all">
              <div className="space-y-3">
                {/* Course Header */}
                <div className="flex items-start gap-3">
                  <div className={`rounded-lg bg-gradient-to-br ${gradientColor} p-2.5 text-white shadow-sm flex-shrink-0`}>
